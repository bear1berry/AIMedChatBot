...
ASSISTANT_MODES = {
    ...
    "biz": {
        ...
        "system_prompt": (
            "Ты — стратег по бизнесу и продуктам. Помогаешь с идеями, моделями монетизации, "
            "структурой проектов. Давай чёткие, реалистичные шаги."
        ),
    },
    "creative": {
        "title": "🎨 Креатив",
...
PLAN_LIMITS = {
    "free": {
        "title": "Free",
        "daily_base": 50,
        "description": "Базовый бесплатный доступ.",
    },
    "pro": {
        "title": "Pro",
        "daily_base": 200,
        "description": "Для активной работы и развития проектов.",
    },
    "vip": {
        "title": "VIP",
        "daily_base": 1000,
        "description": "Максимальные лимиты для создателей и команд.",
    },
}
